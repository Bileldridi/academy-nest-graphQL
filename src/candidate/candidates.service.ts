...
export class CandidatesService {
    ...
    async create(candidate) {
        ...
        if (candidate.sendEmail) {
            await this.sendEmailAccess(candidate.email, randomPass)
        }
        return userResult;
    }
    ...
    async sendEmailAccess(email, pass): Promise<any> {
