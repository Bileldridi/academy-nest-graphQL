...
<div style="color:#555555;font-family:Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;line-height:1.2;padding-top:20px;padding-right:40px;padding-bottom:10px;padding-left:40px;">
<div style="font-size: 14px; line-height: 1.2; color: #555555; font-family: Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 17px;">
<p style="font-size: 18px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 22px; margin: 0;"><span style="font-size: 18px;">Please do not share this email with anyone, it contains sensitive information. we also recommend to change the random genrated password from the profile menu.</span></p>
<p style="font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;"> </p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
export const sendCertif = async (user, pathName, certifImg): Promise<any> => {
        ...
        <div class="_1_uypmLpuvFfZLEG0VSc1I">
            <div class="_2zX2caDms6Dyd9Ch--6tVn _3WlDZpUcpzvjQ13y53lZLc">
                ...
                <div class="_1PykQrbOAi1vvEtfcvQEia">
                                                                ...
                                                                <table bgcolor="white" style="width:100%;">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" style="padding:7px 0;">
                                                                                <span
                                                                                    style="color: rgb(85, 84, 84); font-size: small; font-family: Open-sans, sans-serif, serif, EmojiFont;"><span
                                                                                        style="font-size:28px;font-weight:500;text-transform:uppercase;line-height:33px;">Félicitations
                                                                                        ${user.firstname}
                                                                        ...
                                                                        <tr>
                                                                            <td style="padding:0;">
                                                                                <img style="width:50%;" src=${certifImg} />
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td
                                                                            ...
                                                                            <td style="width:20px;padding:7px 0;">&nbsp;
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                    ...
                    <div class="_3hNohI4SDCYc8T81_nBwJA"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    const message = {
        from: 'FivePoints <contact@mailing.fivepoints.fr>',
        to: user.email,
        subject: 'FivePoints Academy - Certification',
        html: htmlMsg,
    };
...
export const sendCertificate = async (certificate): Promise<any> => {
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" style="padding:7px 0;">
                                                                                <span
                                                                                    style="color: rgb(85, 84, 84); font-size: small; font-family: Open-sans, sans-serif, serif, EmojiFont;"><span
                                                                                        style="font-size:28px;font-weight:500;text-transform:uppercase;line-height:33px;">Félicitations
                                                                                        ${certificate.candidate.firstname}
                                                                                        ${certificate.candidate.lastname},</span><br>
...
export const sendContactMail = async (email): Promise<any> => {
                                                                ...
                                                                <table bgcolor="white" style="width:100%;">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" style="padding:7px 0;">
                                                                                        <span
                                                                                        style="font-size:16px;font-weight:500;text-transform:uppercase;line-height:25px;">Bonjour, merci pour votre message, notre équipe vous repondra dans les plus brefs délais.</span>
...
export const receiveContactMail = async (email, name, msg): Promise<any> => {
                                                                ...
                                                                <table bgcolor="white" style="width:100%;">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" style="padding:7px 0;">
                                                                                        <span
                                                                                        style="font-size:16px;font-weight:500;text-transform:uppercase;line-height:25px;">name : ${name}</span><br>
                                                                                        <span
                                                                                        style="font-size:16px;font-weight:500;text-transform:uppercase;line-height:25px;">message : ${msg}</span><br>
